...
cd kernel_memory && ./bin/kernel_memory memoria_memoria_worst.config &
cd ..
sleep 1
...
echo "=== Prueba Memoria WORST iniciada (4 sticks: 16+32+64+128 = 240 bytes) ==="