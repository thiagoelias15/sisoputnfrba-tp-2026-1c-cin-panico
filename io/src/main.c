        ...
        while(io_corriendo) {
            ...
            switch(cod_op) {
                ...
                case SYSCALL_STDOUT:
                    ...
                    /* Recibimos 3 numeros entero que nos mando el scheduler tamaño,direccion y pid y los guardamos en sus variables correspondientes, 
